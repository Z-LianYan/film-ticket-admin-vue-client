<template>
  <el-card class="box-card">
    ...
    >
      ...
      <el-table-column prop="hall_name" label="影厅" width="90"></el-table-column>
      ...
      <el-table-column prop="start_play_time" label="开始放映时间"></el-table-column>
      <el-table-column prop="end_play_time" label="结束放映时间"></el-table-column>
