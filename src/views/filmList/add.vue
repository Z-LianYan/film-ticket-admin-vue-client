<template>
  <el-card class="box-card">
    ...
    >
      ...
      <el-form-item label="电影类型" prop="category_id">
        <el-select v-model="ruleForm.categorys" multiple placeholder="请选择电影类型">
          <el-option
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        categorys: [{ required: true, message: "请电影类型", trigger: "change" }],
      },
      categoryList:[]
    };
  },
